<?php /*a:12:{s:48:"F:\site\ztx\view\ADMIN\table_builder\layout.html";i:1661477590;s:34:"F:\site\ztx\view\ADMIN\layout.html";i:1642750854;s:45:"F:\site\ztx\view\ADMIN\public\breadcrumb.html";i:1651030176;s:48:"F:\site\ztx\view\ADMIN\table_builder\search.html";i:1642750854;s:49:"F:\site\ztx\view\ADMIN\table_builder\toolbar.html";i:1642750854;s:41:"F:\site\ztx\view\ADMIN\public\header.html";i:1661162617;s:41:"F:\site\ztx\view\ADMIN\public\css_js.html";i:1650874430;s:45:"F:\site\ztx\view\ADMIN\index\webuploader.html";i:1660828476;s:39:"F:\site\ztx\view\ADMIN\public\left.html";i:1648199940;s:41:"F:\site\ztx\view\ADMIN\public\footer.html";i:1648198182;s:46:"F:\site\ztx\view\ADMIN\public\foot_css_js.html";i:1648736694;s:39:"F:\site\ztx\view\ADMIN\index\index.html";i:1661507844;}*/ ?>
...
<section class="content">
    ...
    <?php echo !empty($ZTX_options['extra_css']) ? htmlentities($ZTX_options['extra_css']) : (isset($extra_css) && ($extra_css !== '')?$extra_css:''); ?>
...
<?php endif; ?>
    ...
    <style>
        /* ZTX-设置表格边框颜色 */
        <?php if($ZTX_options['border_color']!=''): ?>
        .table tr,td,caption{
            border: 1px solid <?php echo htmlentities($ZTX_options['border_color']); ?>;
            }
        <?php endif; ?>
    </style>
    <script>
	...
	//ZTX-003前端把转义符转为普通字符 by折腾侠
        $(function() {
            var options = {
                ...
                sortName      : "<?php echo !empty($ZTX_options['sort_name']) ? htmlentities($ZTX_options['sort_name']) : htmlentities($unique_id); ?>",         // 排序列名称
                sortOrder     : "<?php echo !empty($ZTX_options['table_sort']) ? htmlentities($ZTX_options['table_sort']) : 'desc'; ?>",                 // 排序方式  asc 或者 desc
                ...
                pageSize      : "<?php echo !empty($ZTX_options['page_ize']) ? htmlentities($ZTX_options['page_ize']) : htmlentities($page_size); ?>",         // 每页显示的行数
                layerOpen     : "<?php echo htmlentities($layer_open); ?>",        // 添加/编辑等页启用layer弹层加载
                emptyTips     : "<?php echo !empty($ZTX_options['empty_tips']) ? htmlentities($ZTX_options['empty_tips']) : htmlentities($empty_tips); ?>",        // 空数据提示信息
                ...
                classes:"<?php echo !empty($ZTX_options['classes']) ? htmlentities($ZTX_options['classes']) : 'table table-hover'; ?>", //设置表格样式
                escape: <?php echo !empty($ZTX_options['escape']) ? htmlentities($ZTX_options['escape']) : 'true'; ?>,     // 转义HTML字符串
                <?php echo $ZTX_options['row_style']; ?>             //设置行样式
                <?php echo $ZTX_options['others']; ?> 
                    ...
                    <?php if(is_array($columns) || $columns instanceof \think\Collection || $columns instanceof \think\Paginator): $i = 0; $__LIST__ = $columns;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$column): $mod = ($i % 2 );++$i;?>
                        {
                            ...
                            <?php endif; if($column['param']&&$column['type']!='customize'): if($column['name'] == 'status'): ?>
									formatter: function(value, row, index) {
										if (value == 0) {
    ...
    <?php echo !empty($ZTX_options['extra_html']) ? htmlentities($ZTX_options['extra_html']) : (isset($extra_html_content_bottom) && ($extra_html_content_bottom !== '')?$extra_html_content_bottom:''); ?>
    
    <?php echo !empty($ZTX_options['extra_js']) ? htmlentities($ZTX_options['extra_js']) : (isset($extra_js) && ($extra_js !== '')?$extra_js:''); ?>
</section>
<!--内容结束-->
