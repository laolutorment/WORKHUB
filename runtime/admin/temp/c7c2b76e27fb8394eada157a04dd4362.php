<?php /*a:3:{s:51:"F:\site\haoqi\view\ADMIN\database\excel_import.html";i:1655218545;s:48:"F:\site\haoqi\view\ADMIN\public\base_css_js.html";i:1654342741;s:47:"F:\site\haoqi\view\ADMIN\index\webuploader.html";i:1650961026;}*/ ?>
...
<body>
    <form target="_blank" name="form-builder" class="col-12 form_builder" id="form-builder" method="post"
        action="/ADMIN/Database/excel_import_Post.html">
        <input type="hidden" name="table_name" value="<?php echo htmlentities($table_name); ?>">
        <div class="row dd_input_group no-gutters">
            <label class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1 dd_input_l col-form-label " for="file">上传EXCEL文件</label>
            <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
            <input type="file" id="file">
            <a class="btn btn-success " onclick="">上传 </a>
           
            </div>
        </div>
        <div class="row dd_input_group no-gutters">
            <label class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1 dd_input_l col-form-label " for="excel_title">选择EXCEL标题行</label>
            <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
        ...
        <div class="row dd_input_group no-gutters">
            <label class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1 dd_input_l col-form-label " for="col">选择导入字段</label>
            <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                        ...
                        <tr>
                            <td class="text-left">
                                <label class="dd_radio_lable"> 
                                 <input type="checkbox" name="col[]" value="<?php echo htmlentities($k); ?>" class="dd_radio"checked="checked">
                            ...
                            <td> <select id="<?php echo htmlentities($k); ?>" name="changedata[<?php echo htmlentities($k); ?>]">
                                    <option value=""></option>
                                    <option value="datetime">转成时间戳格式</option>
                                </select>
                            </td>
                            <td class="text-center" >
