...
<section class="content">
    ...
    <?php echo !empty($ZTX_options['extra_css']) ? $ZTX_options['extra_css'] : (isset($extra_css) && ($extra_css !== '')?$extra_css:''); ?>
...
<?php endif; ?>
   ...
   <?php echo !empty($ZTX_options['extra_html']) ? $ZTX_options['extra_html'] : (isset($extra_html_content_bottom) && ($extra_html_content_bottom !== '')?$extra_html_content_bottom:''); ?>
    
    <?php echo !empty($ZTX_options['extra_js']) ? $ZTX_options['extra_js'] : (isset($extra_js) && ($extra_js !== '')?$extra_js:''); ?>
</section>
<!--内容结束-->
