        ...
        <div class="row">
            ...
            <form name="form-builder" class="col-12 form_builder" } >
                ...
                <?php if($form_items): ?>
                    ...
                    <!-- 字段循环输出 -->
                    <?php if(is_array($form_items) || $form_items instanceof \think\Collection || $form_items instanceof \think\Paginator): $i = 0; $__LIST__ = $form_items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form_group): $mod = ($i % 2 );++$i;?>
                    <div class="row dd_input_group no-gutters  id=" form_group_<?php echo htmlentities($form_group['name']); ?>">
                        <label class="col-3 col-sm-2 col-md-2 col-lg-2 col-xl-1 dd_input_l col-form-label  for="
                            <?php echo htmlentities($form_group['name']); ?>"><?php echo isset($form_group['title']) ? htmlentities($form_group['title']) : ''; ?></label>
                        <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                            <div class="more_images dd_ts ztx-center">
                                <?php switch($form_group['type']): case "image": ?>
                                
                                <a href="<?php echo !empty($form_group['value']) ? htmlentities($form_group['value']) : '/static/admin/images/nopic.png'; ?>" target="_blank">
                                    <img width="100%" src="<?php echo !empty($form_group['value']) ? htmlentities($form_group['value']) : '/static/admin/images/nopic.png'; ?>"
                                        id="<?php echo htmlentities($form_group['name']); ?>_preview">
                                </a>
                                <?php break; case "images": if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): if(is_array($form_group['value']) || $form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <a href="<?php echo htmlentities($vo['image']); ?>" target="_blank"> <img style="border:5px solid #fcf9f9"
                                        src="<?php echo !empty($vo['small']) ? htmlentities($vo['small']) : htmlentities($vo['image']); ?>" width="49%"></a>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php endif; break; case "file": ?>
                                
                                <a href="<?php echo htmlentities($form_group['value']); ?>" target="_blank">
                                    <p id="<?php echo htmlentities($form_group['name']); ?>" class="text-primary">下载</p>
                                </a>
                                ...
                                <script>
                                    ...
                                    $(function () {
                                        ...
                                        var p_value = getfilename(' <?php echo $form_group['value']; ?> ');
                                        console.log(p_value);
                                        $('#<?php echo htmlentities($form_group['name']); ?>').text(p_value);
                                    });

                                </script>
                                <?php break; case "files": if(!(empty($form_group['value']) || (($form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator ) && $form_group['value']->isEmpty()))): if(is_array($form_group['value']) || $form_group['value'] instanceof \think\Collection || $form_group['value'] instanceof \think\Paginator): $i = 0; $__LIST__ = $form_group['value'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>

                                <a href="<?php echo htmlentities($vo['image']); ?>" target="_blank">
                                    <p class="text-primary"><?php echo htmlentities($vo['title']); ?></p>
                                </a>

                                <?php endforeach; endif; else: echo "" ;endif; ?>
                                <?php endif; break; case "color": ?>
                                
                                <div style="background-color:<?php echo $form_group['value']; ?>;">
                                    <?php echo $form_group['value']; ?>
                                </div>
                                <?php break; default: ?>
                                <font color="black"><?php echo $form_group['value']; ?> </font>
                                <?php endswitch; ?>
