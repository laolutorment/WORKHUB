<?php /*a:10:{s:38:"F:\www\haoqi\view\admin\field\add.html";i:1653276848;s:35:"F:\www\haoqi\view\admin\layout.html";i:1642750854;s:46:"F:\www\haoqi\view\admin\public\breadcrumb.html";i:1651030174;s:42:"F:\www\haoqi\view\admin\public\header.html";i:1648200080;s:42:"F:\www\haoqi\view\admin\public\css_js.html";i:1650874429;s:46:"F:\www\haoqi\view\admin\index\webuploader.html";i:1650961026;s:40:"F:\www\haoqi\view\admin\public\left.html";i:1648199939;s:42:"F:\www\haoqi\view\admin\public\footer.html";i:1648198181;s:47:"F:\www\haoqi\view\admin\public\foot_css_js.html";i:1648736693;s:40:"F:\www\haoqi\view\admin\index\index.html";i:1652865788;}*/ ?>
                    ...
                    <div class="row dd_input_group no-gutters">
                        ...
                        <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                            <select id="module_id" name="module_id" class="form-control">
                                ...
                                <option value="<?php echo htmlentities($module['id']); ?>" <?php echo $module_id==$module['id'] ? 'selected="selected"'  :  ''; ?> ><?php echo htmlentities($module['module_name']); ?> - [ <?php echo htmlentities($module['table_name']); ?> ]</option>
                            ...
                            <div class="dd_radio_lable_left">
                                <label class="dd_radio_lable">
                                    <input type="radio" name="required" value="1" class="dd_radio"
                                           <?php if($info): ?><?php echo $info['required']==1 ? 'checked' : ''; ?><?php endif; ?>><span>是</span>
                                </label>
                                <label class="dd_radio_lable">
                                    <input type="radio" name="required" value="0" class="dd_radio"
                                           <?php if($info): ?><?php echo $info['required']==0 ? 'checked' : ''; else: ?>checked<?php endif; ?>><span>否</span>
                                </label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row dd_input_group no-gutters">
                        ...
                        <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                            <select id="dict_code" name="dict_code" class="form-control">
                                ...
                                <option value="<?php echo htmlentities($dictTypes['id']); ?>" <?php if($info): ?><?php echo $info['dict_code']==$dictTypes['id'] ? 'selected="selected"'  :  ''; ?><?php endif; ?>><?php echo htmlentities($dictTypes['dict_name']); ?> - [ <?php echo htmlentities($dictTypes['remark']); ?> ]</option>
                                <?php endforeach; endif; else: echo "" ;endif; ?>
                            </select>
                        </div>
                        <div class="col-12 offset-sm-2 offset-md-2 offset-lg-0 offset-xl-0 col-sm-10 col-md-10 col-lg-4 col-xl-7 dd_ts">
  ...
  <tr>
    ...
    <tr>
        ...
        <td> <select id="type" name="type" class="form-control">
                                ...
                                <option value="date" <?php if($info): ?><?php echo $info['type']=='date' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>日期</option>
                                <option value="time" <?php if($info): ?><?php echo $info['type']=='time' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>时间</option>
                                <option value="datetime" <?php if($info): ?><?php echo $info['type']=='datetime' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>日期时间</option>
                                <option value="daterange" <?php if($info): ?><?php echo $info['type']=='daterange' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>日期范围</option>
                                <option value="tag" <?php if($info): ?><?php echo $info['type']=='tag' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>标签</option>
                                ...
                                <option value="file" <?php if($info): ?><?php echo $info['type']=='file' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>单文件上传</option>
								...
								<option value="code" <?php if($info): ?><?php echo $info['type']=='code' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>代码编辑器</option>
								<!-- ZTX-007，增加字段模板“代码编辑器” -->
                            </select>
				   </td>
    </tr>
 ...
 <table class="typeTable" cellpadding="2" cellspacing="1"  id="form_setup_table">
  ...
  <table class="typeTable" cellpadding="2" cellspacing="1"  >
        ...
        <td> <select id="table_col_type" name="table_col_type" class="form-control">
                                <option value=''>请选择字段类型</option>
                                <option value="text" <?php if($info): ?><?php echo $info['table_col_type']=='text' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>单行文本</option>                               
                                ...
                                <option value="select" <?php if($info): ?><?php echo $info['table_col_type']=='select' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>普通下拉菜单</option>
                                <option value="select2" <?php if($info): ?><?php echo $info['table_col_type']=='select2' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>高级下拉菜单</option>
                                <option value="image" <?php if($info): ?><?php echo $info['table_col_type']=='image' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>单张图片</option>
                                <option value="images" <?php if($info): ?><?php echo $info['table_col_type']=='images' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>多张图片</option>
                                <option value="color" <?php if($info): ?><?php echo $info['table_col_type']=='color' ? 'selected="selected"'  :  ''; ?><?php endif; ?>>取色器</option>
    ...
    <tr>
        <td>搜索类型</td>
        <td>
            <input type="text" name="search_type" class="form-control" placeholder="请填写搜索类型"  value="<?php echo !empty($info['search_type']) ? htmlentities($info['search_type']) : '='; ?>">
			 <small class="text-muted">
             <i class="fa fa-info-circle"></i> 如：=, <>, >, <, LIKE,in等表达式，如字段可被搜索则必须设置
             </small>
        </td>
    </tr>
	 <tr>
		...
		<label class="dd_radio_lable">
			<input type="radio" name="table_col_align" value="right" class="dd_radio"<?php if($info): ?><?php echo $info['table_col_align']=='right' ? 'checked' : ''; else: ?>checked<?php endif; ?>><span>右对齐</span>
		</label>
		<label class="dd_radio_lable">
			<input type="radio" name="table_col_align" value="center" class="dd_radio"<?php if($info): ?><?php echo $info['table_col_align']=='center' ? 'checked' : ''; else: ?>checked<?php endif; ?>><span>居中</span>
		</label>
		</div>
		</div>
        </td>
	...
	<tr>
        <td>格式化</td>
        <td>
            <input id="table_col_formatter" type="text" name="table_col_formatter" class="form-control" readonly="readonly" value="<?php echo !empty($info['table_col_formatter']) ? htmlentities($info['table_col_formatter']) : 'formatter: function(value, row, index,field) { return value;}'; ?>">
			 <small class="text-muted">
             <i class="fa fa-info-circle"></i> value: 字段值，row：行记录数据，index: 行索引，field: 行字段名。
             </small>
        </td>
    </tr>
...
<tbody>
                    ...
                    <div class="row dd_input_group no-gutters">
                        ...
                        <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                            <textarea class="form-control" name="remark" rows="3" placeholder="请输入字段备注"><?php echo htmlentities((isset($info['remark']) && ($info['remark'] !== '')?$info['remark']:'')); ?></textarea>
                        </div>
                        <div class="col-12 offset-sm-2 offset-md-2 offset-lg-0 offset-xl-0 col-sm-10 col-md-10 col-lg-4 col-xl-7 dd_ts">
                            <small class="text-muted">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tr>
									...
									<div class="card-body">
										...
										<a href="https://bootstrap-table.com/docs/api/table-options/" target="_blank" class="btn btn-app ">bootstrap-table 文档</a>
