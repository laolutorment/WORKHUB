<?php /*a:1:{s:51:"F:\site\haoqi\view\admin\database\excel_import.html";i:1659369253;}*/ ?>
        ...
        <div id="pjax-container">
            ...
            <div class="row dd_input_group no-gutters">
                ...
                <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
                    <select id="excel_title" name="excel_title" class="form-control">
                        <?php $__FOR_START_1469618855__=1;$__FOR_END_1469618855__=$rowCnt+1;for($k=$__FOR_START_1469618855__;$k < $__FOR_END_1469618855__;$k+=1){ ?>
            ...
            <script>
                ...
                function form_submit() {
                    ...
                    //汇总验证
                    console.log('key_validation:'+key_validation);
                    console.log('col_validation:'+col_validation);
                    console.log('Excel_file2_validation:'+Excel_file2_validation);
                    ...
                    if (key_validation && col_validation && Excel_file2_validation) {
                        ...
                        alert(msg+ mag_col_validation+msg_key_validation);
                        return false
                    }
