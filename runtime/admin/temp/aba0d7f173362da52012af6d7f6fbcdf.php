<?php /*a:17:{s:39:"F:\site\ztx\view\admin\info\layout.html";i:1661217718;s:34:"F:\site\ztx\view\admin\layout.html";i:1642750854;s:45:"F:\site\ztx\view\admin\public\breadcrumb.html";i:1651030176;s:44:"F:\site\ztx\view\admin\info\items\group.html";i:1661212719;s:44:"F:\site\ztx\view\admin\info\items\image.html";i:1661183767;s:45:"F:\site\ztx\view\admin\info\items\images.html";i:1661187296;s:43:"F:\site\ztx\view\admin\info\items\file.html";i:1661217493;s:44:"F:\site\ztx\view\admin\info\items\files.html";i:1661212574;s:44:"F:\site\ztx\view\admin\info\items\color.html";i:1661212582;s:46:"F:\site\ztx\view\admin\info\items\default.html";i:1661212671;s:41:"F:\site\ztx\view\admin\public\header.html";i:1661162617;s:41:"F:\site\ztx\view\admin\public\css_js.html";i:1650874430;s:45:"F:\site\ztx\view\admin\index\webuploader.html";i:1660828476;s:39:"F:\site\ztx\view\admin\public\left.html";i:1648199940;s:41:"F:\site\ztx\view\admin\public\footer.html";i:1648198182;s:46:"F:\site\ztx\view\admin\public\foot_css_js.html";i:1648736694;s:39:"F:\site\ztx\view\admin\index\index.html";i:1661162848;}*/ ?>
...
<div class="tab-content no-padding">
    ...
    <?php if(is_array($items) || $items instanceof \think\Collection || $items instanceof \think\Paginator): $i = 0; $__LIST__ = $items;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$form_group): $mod = ($i % 2 );++$i;switch($form_group['type']): case "image": ?>
        ...
        <div class="more_images dd_ts">
            <div id="more_images_<?php echo htmlentities($form['name']); ?>">
				...
				<!-- ZTX-004  by 折腾侠-->
					 ...
					 <a href="<?php echo htmlentities($vo['image']); ?>" target="_blank"> <img  style="border:5px solid #fcf9f9" src="<?php echo !empty($vo['small']) ? htmlentities($vo['small']) : htmlentities($vo['image']); ?>" width="49%" ></a>
    ...
    <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
        ...
        <div class="input-group">
            ...
            <div class="more_images dd_ts ztx-center">
                ...
                <a href="<?php echo htmlentities($form['value']); ?>" target="_blank"><p id="<?php echo htmlentities($form['name']); ?>" class="text-primary">下载</p></a>
                       
                <script>
                    //ZTX-js方式获取url文件名
                    $(function() {
                        var p_value=getfilename('<?php echo $form['value']; ?>');
                        console.log(p_value);
                        $('#<?php echo htmlentities($form['name']); ?>').text(p_value);
                    });
        ...
        <div class="more_images dd_ts ztx-center">
            <div id="more_images_<?php echo htmlentities($form['name']); ?>">
                ...
                <!-- ZTX-002  by 折腾侠删除原有代码，改为跟图片显示容器一样的代码-->
                        ...
                        <a href="<?php echo htmlentities($vo['image']); ?>" target="_blank"><p class="text-primary"><?php echo htmlentities($vo['title']); ?></p></a>
    ...
    <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
        ...
        <div class="input-group">
            ...
            <div class="more_images dd_ts ztx-center">
               ...
               <div style="background-color:<?php echo $form['value']; ?>;">
                <?php echo $form['value']; ?>
               </div>
    ...
    <div class="col-9 col-sm-9 col-md-9 col-lg-6 col-xl-4">
        ...
        <div class="input-group">
            ...
            <div class="more_images dd_ts ztx-center" >
                ...
                <font color="black"><?php echo $form['value']; ?> </font>
