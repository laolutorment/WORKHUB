                    ...
                    <table class="typeTable" cellpadding="2" cellspacing="1">
                        ...
                        <td> <select id="table_col_type" name="table_col_type" class="form-control">
                                ...
                                <option value="color" <?php if($info): ?><?php echo $info['table_col_type']=='color' ? 'selected="selected"'
                                    ...
                                    <option value="info" <?php if($info): ?><?php echo $info['table_col_type']=='info' ? 'selected="selected"'
                                     :  ''; ?><?php endif; ?>>详情链接</option>
                        ...
                        <tr>
                            ...
                            <td>
                                <label class="dd_radio_lable">
                                    <input type="radio" name="table_col_visible" value="true" class="dd_radio" <?php if($info): ?><?php echo $info['table_col_visible']=='true' ? 'checked' : ''; else: ?>checked<?php endif; ?>><span>显示</span>
                                </label>
                                <label class="dd_radio_lable">
                                    <input type="radio" name="table_col_visible" value="false" class="dd_radio" <?php if($info): ?><?php echo $info['table_col_visible']=='false' ? 'checked' : ''; ?><?php endif; ?>><span>隐藏</span>
                                </label>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                -->
                                    ...
                                    <textarea id="table_col_formatter" name="table_col_formatter" ><?php echo !empty($info['table_col_formatter']) ? htmlentities($info['table_col_formatter']) : 'function(value, row, index,field) { return value;}'; ?></textarea>
                                <small class="text-muted">
                                    <i class="fa fa-info-circle"></i> 当列表类型为“自定义时”有效。value: 字段值，row：行记录数据，index: 行索引，field: 行字段名。列样式单独设置：<br>cellStyle:function(value,row,index){  <p>
                                        return {css:{"background-color":"rgba(255,250,250,0.7)"}}; }</p>
                                </small>
                            </td>
                        </tr>
