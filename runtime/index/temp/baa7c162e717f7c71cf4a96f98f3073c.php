<?php /*a:5:{s:40:"./template/default/index/html/index.html";i:1676966701;s:62:"F:\site\ztx\public\template\default\index\html\common_css.html";i:1642750854;s:65:"F:\site\ztx\public\template\default\index\html\common_header.html";i:1648430456;s:65:"F:\site\ztx\public\template\default\index\html\common_footer.html";i:1642750854;s:61:"F:\site\ztx\public\template\default\index\html\common_js.html";i:1642750854;}*/ ?>
<!DOCTYPE html>
   ...
   <div class="bg-white"> 
    ...
    <div class="slider-area slider-two">
        <div class="preview-2">
            ...
            $__LIST__ = \app\common\model\Ad::where($__WHERE__)->order('sort asc,id desc')->select(); if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?>
                <img src="<?php echo htmlentities($ad['image']); ?>" alt="<?php echo htmlentities($ad['name']); ?>" title="#slider-1-caption<?php echo htmlentities($key+1); ?>"/>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div> 
            ...
            $__LIST__ = \app\common\model\Ad::where($__WHERE__)->order('sort asc,id desc')->select(); if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ad): $mod = ($i % 2 );++$i;?>
            <div id="slider-1-caption<?php echo htmlentities($key+1); ?>" class="nivo-html-caption nivo-caption">
                <div class="banner-content slider-<?php echo htmlentities($key+1); ?>">
                    <div class="container">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="text-content-wrapper">
                                    <div class="text-content">
                                        <h1 class="title1"><?php echo htmlentities($ad['name']); ?></h1>
                                        <p class="sub-title hidden-sm hidden-xs"><?php echo textareaBr($ad['description']); ?></p>
                                        <div class="banner-readmore">
                                            <a class="button-default bg-blue" href="<?php echo htmlentities($ad['url']); ?>">了解详情</a>	                
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="about-container">
                        <h3>WHY US ?</h3>
                        <p><?php echo \app\common\model\Debris::where("name",'AboutUs')->where("status", 1)->value("content");?></p>
                        <a class="button-default" href="<?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",6)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['url'];}?>">查看更多</a>	      
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-12">
                    <div class="section-title-wrapper">
                        <div class="section-title">
                            <h3><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",8)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['cate_name'];}?></h3>
                            <p><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",8)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['en_name'];}?></p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="single-product-item">
                        ...
                        <div class="single-product-text">
                            ...
                            <div class="product-buttons">
                                <a class="button-default cart-btn floatright" href="<?php echo htmlentities($list['url']); ?>">查看详细</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title-wrapper">
                        <div class="section-title">
                            <h3><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",4)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['cate_name'];}?></h3>
                            <p><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",4)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['en_name'];}?></p>
                        </div>
             ...
             if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                <div class="single-latest-item col-md-6">
                    ...
                    <div class="single-latest-image">
                        <a href="<?php echo htmlentities($list['url']); ?>"><img src="<?php echo htmlentities($list['image']); ?>" ></a>
                    </div>
                    <?php endif; ?>
                    <div class="single-latest-text">
                        <h3><a href="<?php echo htmlentities($list['url']); ?>"><?php echo htmlentities($list['title']); ?></a></h3>
                        <div class="single-item-comment-view">
                           <span><i class="zmdi zmdi-calendar-check"></i><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($list['create_time'])? strtotime($list['create_time']) : $list['create_time'])); ?></span>
                           ...
                           <!--<span><i class="zmdi zmdi-label"></i><?php echo htmlentities($list['source']); ?></span>-->
                       </div>
                       <p class="line_three"><?php echo htmlentities($list['summary']); ?></p>
                       <a href="<?php echo htmlentities($list['url']); ?>" class="button-default">查看详细</a>
                    </div>
                </div>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title-wrapper">
                        <div class="section-title">
                            <h3><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",7)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['cate_name'];}?></h3>
                            <p><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",7)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['en_name'];}?></p>
                        </div>
            ...
            if ($__CATE__ && !empty($__CATE__->module->getData('table_name'))) {
             ...
             if(is_array($__LIST__) || $__LIST__ instanceof \think\Collection || $__LIST__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__LIST__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                        <div class="sin-testiText">
                            <h2><a href="<?php echo htmlentities($list['url']); ?>"><?php echo htmlentities($list['title']); ?></a></h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title-wrapper">
                        <div class="section-title">
                            <h3><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",11)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['cate_name'];}?></h3>
                            <p><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",11)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['en_name'];}?></p>
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-item">
                        ...
                        <div class="single-item-image overlay-effect">
                            <a href="<?php echo htmlentities($list['download']); ?>" target="_blank"><img src="<?php echo htmlentities($list['image']); ?>" alt="<?php echo htmlentities($list['title']); ?>"></a>
                        </div>
                        <?php endif; ?>
                        <div class="single-item-text">
                            <h4><a href="<?php echo htmlentities($list['download']); ?>"><?php echo htmlentities($list['title']); ?></a></h4>
                            <div class="single-item-text-info">
                                <span>作者： <span><?php echo htmlentities($list['author']); ?></span></span>
                                <span>时间：<span><?php echo htmlentities(date("Y-m-d",!is_numeric($list['create_time'])? strtotime($list['create_time']) : $list['create_time'])); ?></span></span>
                            </div>  
                        </div>
                        <div class="button-bottom">
                            <a href="<?php echo htmlentities($list['download']); ?>" class="button-default" target="_blank">立即下载</a>
                        </div>
                    </div>
                </div> 
                <?php endforeach; endif; else: echo "" ;endif; ?>
                <div class="col-md-12 col-sm-12 text-center">
                    <a href="<?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",17)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
            }echo $__CATE__['url'];}?>" class="button-default button-large">查看更多<i class="zmdi zmdi-chevron-right"></i></a>
                </div>
            </div>
        </div>
    </div>
