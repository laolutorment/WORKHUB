<?php /*a:7:{s:61:"F:\site\ztx\public\template\default\index\html\team_list.html";i:1648200076;s:62:"F:\site\ztx\public\template\default\index\html\common_css.html";i:1642750854;s:65:"F:\site\ztx\public\template\default\index\html\common_header.html";i:1648430456;s:65:"F:\site\ztx\public\template\default\index\html\common_banner.html";i:1642750854;s:62:"F:\site\ztx\public\template\default\index\html\common_nav.html";i:1642750854;s:65:"F:\site\ztx\public\template\default\index\html\common_footer.html";i:1642750854;s:61:"F:\site\ztx\public\template\default\index\html\common_js.html";i:1642750854;}*/ ?>
<!DOCTYPE html>
   ...
   <div class="bg-white"> 
              ...
              $__CATE__->url = $__CATE__->url . '';
                    ...
                    <div class="breadcrumb-bar">
                        <ul class="breadcrumb text-center">
                            <li><a href="/">首页</a></li>
                            <!--<li><?php $__CATE__ = \app\common\model\Cate::with(['module'])->where("id",12)->find();if ($__CATE__) { $__CATE__->url = getUrl($__CATE__->toArray());
            if (!empty('')) {
              $__CATE__->url = $__CATE__->url . '';
                   ...
                   <div class="col-md-10 col-md-offset-1">
                           <div class="form-container">
                               <div class="box-select">
                                   区域：
                                   <?php $__DICTS__ = \app\common\model\Dictionary::where('status',1)->where('dict_type',10)->order('sort ASC,id desc')->select()->toArray();
                   $__DICTS__ = changeDict($__DICTS__, 'area', '全部');
         if(is_array($__DICTS__) || $__DICTS__ instanceof \think\Collection || $__DICTS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DICTS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                   <a href="<?php echo htmlentities($list['url']); ?>" <?php if($list['current']): ?>class="hover"<?php endif; ?>><?php echo htmlentities($list['dict_label']); ?></a>
                                   <?php endforeach; endif; else: echo "" ;endif; ?>
                               </div>
                               <div class="box-select">
                                   性别：
                                   <?php $__DICTS__ = \app\common\model\Dictionary::where('status',1)->where('dict_type',4)->order('sort ASC,id desc')->select()->toArray();
                   $__DICTS__ = changeDict($__DICTS__, 'sex', '不限');
         if(is_array($__DICTS__) || $__DICTS__ instanceof \think\Collection || $__DICTS__ instanceof \think\Paginator): $i = 0; $__LIST__ = $__DICTS__;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                   <a href="<?php echo htmlentities($list['url']); ?>" <?php if($list['current']): ?>class="hover"<?php endif; ?>><?php echo htmlentities($list['dict_label']); ?></a>
                                   <?php endforeach; endif; else: echo "" ;endif; ?>
                               </div>
    ...
    <div class="teachers-area">
        <div class="container">
            ...
            $__SEARCH__ = getSearchField('area,sex');
            // 查询子分类,列表要包含子分类内容
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6">
                        <div class="single-teacher-item">
                            ...
                            <div class="single-teacher-text">
                                ...
                                <p class="lin_two"><?php echo htmlentities($list['summary']); ?></p>
                            </div>
                        </div>
                    </div>
